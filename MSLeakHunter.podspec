#
#  Be sure to run `pod spec lint MSLeakHunter.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of MSLeakHunter.podspec in Markdown format.
  ...
  s.source       = { :git => "https://github.com/mindsnacks/MSLeakHunter", :tag => "0.0.1" }
